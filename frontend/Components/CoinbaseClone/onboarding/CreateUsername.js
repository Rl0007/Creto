...
const CreateUsername = ({ navigation }) => {
  ...
  const createUser = async () => {
    ...
    if (username !== "") {
      if (!user.length > 0) {
        ...
        const encryptionKeyStore = web3Js.eth.accounts.encrypt(
          privateKey,
          recoveryPhrase
        );
        ...
        newUser.set("private_key", privateKey);
        newUser.signUp();
  ...
  // image url previous ../../../../frontend/create-username.png
  return (
        ...
        >
          ...
          <View style={styles.formContainer}>
            <TouchableOpacity
              ...
              style={[
                styles.button,
                { backgroundColor: username === "" ? "gray" : "#1652F0" },
              ]}
              onPress={() => createUser()}
            >
